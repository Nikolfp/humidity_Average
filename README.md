...
> Άνοιγμα αυτής της σελίδας στο [https://nikolfp.github.io/humidity_average/](https://nikolfp.github.io/humidity_average/)
...
* αναζήτηση για **https://github.com/nikolfp/humidity_average** και εισαγωγή
...
* επικολλήστε **https://github.com/nikolfp/humidity_average** και κάντε κλικ στην εισαγωγή
